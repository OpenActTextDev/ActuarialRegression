...
format:
  html:
#  docx:
    include-before-body: ShowHide.js
...
`r HideProofTheory('Section4122.Hide', 'A More Detailed Plan')`   
...
Topics3 <- c("Recurrent Neural Networks", "Artificial Intelligence and ChatGPT",
             "Dani Bauer Insights", "Non-Supervised Learning and Applications")
...
Presenter <- c(rep("Jed",2), rep("Andrés", 4), rep("Jed",2), "Fei",
               "Jed", "Jed", "Dani", "Andrés")
...
**Note**: I am experimenting with Quarto, It enables you to weave together content and executable code into a finished document. To learn more about Quarto see <https://quarto.org>.
...
I built this figure using <https://alexlenail.me/NN-SVG/AlexNet.html>.

```{r, echo=FALSE, out.width='120%', asp = 0.2}
knitr::include_graphics("FirstGraph.svg")
