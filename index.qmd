...
Presenter <- c(rep("Jed",2), rep("Andrés", 3), rep("Jed",3), "Fei",
               "Jed", "Jed", "Dani", "Andrés")
DataSets <- c("LogisticGLM.ipynb", 
  '<br><a href="https://openacttextdev.github.io/RegressionSpanish/index.html">Health Expenditures</a>',
...
Listed here are *many* freely available resources to learn about machine learning. You will *not* need these resources for the short course. Our hope is that the course will inspire some attendees to continue learning about machine learning approaches after the course. If you wish to continue your learning journey, these resources may be useful to you.
