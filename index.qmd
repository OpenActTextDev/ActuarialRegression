...
Topics2 <- c("Trees, Boosting, Bagging", 
             '<a href="https://github.com/OpenActTextDev/ActuarialRegression/blob/main/Presentations/ColombiaSession3B_30June.pdf">Big Data, Dimension Reduction and Non-Supervised Learning</a>',
            '<a href="https://github.com/OpenActTextDev/ActuarialRegression/blob/main/Presentations/ColombiaSession4A_30June.pdf">Neural Networks</a>', 
            '<a href="https://github.com/OpenActTextDev/ActuarialRegression/blob/main/Presentations/ColombiaSession4B_30June.pdf">Graphic Data Neural Networks</a>',
            "Fei Huang Thoughts on Ethics")
Topics3 <- c('<a href="https://github.com/OpenActTextDev/ActuarialRegression/blob/main/Presentations/ColombiaSession5A_30June.pdf">Recurrent Neural Networks, Word Embedding</a>', 
             '<a href="https://github.com/OpenActTextDev/ActuarialRegression/blob/main/Presentations/ColombiaSession5B_27June.pdf">Artificial Intelligence, Natural Language Processing, and ChatGPT</a>',
...
'<a href="https://nbviewer.org/github/OpenActTextDev/ActuarialRegression/blob/main/Notebooks/HousePriceRegression.ipynb">Seattle House Prices</a><br><a href="https://nbviewer.org/github/OpenActTextDev/ActuarialRegression/blob/main/Notebooks/ClaimCounts.ipynb">Claim Counts</a>', 
'<a href="https://nbviewer.org/github/OpenActTextDev/ActuarialRegression/blob/main/Notebooks/MNIST.ipynb">MNIST Digits Data</a>', "",
'<a href="https://nbviewer.org/github/OpenActTextDev/ActuarialRegression/blob/main/Notebooks/StockReturns.ipynb">Insurance Stock Returns</a>',
  rep("", 3))
Footer_row <- c("", "",
