...
Topics1 <- c('<a href="https://github.com/OpenActTextDev/ActuarialRegression/blob/main/Presentations/ColombiaSession1A_25June.pdf">Welcome and Foundations <br> Hello to Google Colab</a>', 
             '<a href="https://github.com/OpenActTextDev/ActuarialRegression/blob/main/Presentations/ColombiaSession1B_25June.pdf">Classical Regression Modeling</a>',
             "Regularization, Resampling, Cross-Validation", "Classification")
Topics2 <- c("Trees, Boosting, Bagging", 
             '<a href="https://github.com/OpenActTextDev/ActuarialRegression/blob/main/Presentations/ColombiaSession3B_25June.pdf">Big Data, Dimension Reduction and Non-Supervised Learning</a>',
